...
<head>
   ...
   <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="agregar_pagoOK.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
			 ...
			 <tr>
               ...
               <td height="35"><input type="text" name="u_surname" id="boxx" value="<?php echo $surname; ?>" placeholder="Member Surname" maxlength="30" readonly/>
