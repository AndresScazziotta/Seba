				...
				<tbody>
					...
					if (mysqli_affected_rows($con) != 0) {
					    ...
					    //    echo "<td>" . $row['pid'] . "</td>";
					        ...
					        echo '<td><a href=editar_plan.php?id="'.$row['pid'].'"><input type="button" class="a1-btn a1-blue" id="boxxe" style="width:100%" value="Editar Plan" ></a><form action="eliminar_plan.php" method="post" onSubmit="return ConfirmDelete();"><input type="hidden" name="name" value="' . $msgid .'"/><input type="submit" id="button1" value="Eliminar Plan" class="a1-btn a1-orange"/></form></td></tr>';
