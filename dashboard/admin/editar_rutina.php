				...
				<?php
					...
					if (mysqli_affected_rows($con) != 0) 
					{
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
						{
					              ...
					              echo '<td><a href="edicion_rutina.php?id='.$row['tid'].'"><input type="button" class="a1-btn a1-blue" id="boxxe" value="Editar Rutina" ></a></td>';
								 // echo '<td><a href="deleteroutine.php?id='.$row['tid'].'"><input type="button" class="a1-btn a1-blue" value="Delete Routine" ></a></td></tr>';
								 echo "<td><form action='borrar_rutina.php' method='post' onsubmit='return ConfirmDelete()'><input type='hidden' name='name' value='" . $row['tid'] . "'/><input type='submit' value='Eliminar' width='20px' id='boxxe' class='a1-btn a1-orange'/></form></td></tr>";
